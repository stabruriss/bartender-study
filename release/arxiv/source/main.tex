...
\hypersetup{pdftitle={Bartender: Continuous Worktree Reconciliation with Author-Routed Conflict Handback for Resident Multi-Agent Development},pdfauthor={Nan Wu}}
\raggedbottom
...
\author*[1]{\fnm{Nan} \sur{Wu}}\email{chris@chriswu.xyz}
\affil[1]{\orgname{Independent Researcher}\\ORCID: \href{https://orcid.org/0009-0001-4129-9569}{0009-0001-4129-9569}}
...
The author develops Kota, the system in which Bartender is implemented.
\subsection*{Data and code availability}
Simulation code, configurations, seeds, per-cell aggregates, paired differences, supplementary figures, the conformance fixtures and results, and the deployment dataset with its methods note are available at \url{https://github.com/stabruriss/bartender-study}. The raw simulation record archive (4.2 GB in four parts) is identified by SHA-256 in that repository's \texttt{release/RAW\_ARCHIVES.json}, which also gives its current download location. The Kota source analyzed is public at \url{https://github.com/stabruriss/kota-app} at the commit cited in Section~\ref{sec:mechanism}.
\begin{appendices}
